...
export const MetaSchema = z.object({
  ...
  valor_alvo: z.number().positive('Valor alvo deve ser maior que zero'),
...
export const MetaUpdateSchema = MetaSchema.partial().refine((dados) => Object.keys(dados).length > 0, {
